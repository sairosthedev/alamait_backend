...
const createPayment = async (req, res) => {
    try {
        ...
        // ✅ ENHANCED PAYMENT SERVICE HANDLES ALL TRANSACTIONS NOW
        // The old transaction creation code has been removed to prevent conflicts
        ...
        const response = {
            success: true,
            message: 'Payment created successfully with enhanced double-entry accounting',
            payment: populatedPayment,
            accounting: {
                transactionCreated: true,
                message: 'Enhanced payment service handles all double-entry accounting'
            }
        };
