...
// Finance routes - can view all except CEO-only reports
router.use(checkRole('finance', 'finance_admin', 'finance_user'));

// Upload report
router.post('/upload', reportUpload.single('file'), reportController.uploadReport);

// Get all reports (finance can see all except CEO-only)
